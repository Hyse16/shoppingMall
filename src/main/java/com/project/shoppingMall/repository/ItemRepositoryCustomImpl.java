...
import static com.project.shoppingMall.domain.QItemImg.itemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    private BooleanExpression searchSellStatusEq(ItemSellStatus seSellStatus) {
        return seSellStatus == null ? null : QItem.item.itemSellStatus.eq(seSellStatus);
    }
